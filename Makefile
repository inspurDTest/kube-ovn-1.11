...
release-arm: build-go-arm
	...
	docker buildx build --platform linux/arm64 -t $(REGISTRY)/kube-ovn:$(DEBUG_TAG) --build-arg BASE_TAG=$(DEBUG_TAG)-arm64 -o type=docker -f dist/images/Dockerfile dist/images/
